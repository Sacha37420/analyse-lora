...
class KeycloakUser:
    """Représentation minimale d'un utilisateur Keycloak construite depuis les claims JWT."""
...
class KeycloakJWTAuthentication(BaseAuthentication):
    """
    Valide les Bearer JWT Keycloak via l'endpoint JWKS du realm.
    Les clés sont mises en cache au niveau de la classe.
    """
